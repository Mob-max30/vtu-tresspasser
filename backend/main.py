...
from api import routes_project, routes_agent, routes_results, routes_analytics, routes_webcmd_poc
...
app.include_router(routes_webcmd_poc.router, prefix="/api/webcmd-poc", tags=["webcmd-poc"])
